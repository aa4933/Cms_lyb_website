...
<div class="pad-lr-10">
	...
	<form id="myform" name="myform" action="<?php echo u('Company/del');?>" method="post" onsubmit="return check();">
...
function edit(flink_id, name) {
	...
	window.top.art.dialog({title:lang_edit+'--'+name,id:'edit',iframe:'?m=Company&a=edit&id='+flink_id,width:'450',height:'220'}, 
		function(){
...
var lang_name = "友情链接";
function check(){
	if($("#myform").attr('action') != '<?php echo u("Company/ordid");?>') {
		var ids='';
...
function status(id,type){
    $.get("<?php echo u('Company/status');?>", { id: id, type: type }, function(jsondata){
...
function sort(id,type,num){
    ...
    $.get("<?php echo u('Company/sort');?>", { id: id, type: type,num:num }, function(jsondata){
