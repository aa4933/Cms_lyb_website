...
<div id="header">
    ...
    <div class="col-auto" style="overflow: visible">
		...
		<div class="log_right white cut_line">
	        <a target="_blank" href="http://w.jieqiangtec.com">官方网站</a>			
			<span>|</span>
			<a target="_blank" href="http://bbs.jieqiangtec.com">支持论坛</a>
			<span> </span>
			<a target="_blank" href="http://w.jieqiangtec.com">Provided by (JieQiang.com)</a>			
        </div>             
    </div>
    ...
    <div class="right_main">
        ...
        <div class="rmc">
            ...
            <div class="content" style="position:relative; overflow:hidden">
                <iframe name="right" id="rightMain" src="<?php echo u('Public/main');?>" frameborder="false" scrolling="auto" style="overflow-x:hidden;border:none;" width="100%" height="auto" allowtransparency="true">                	
                </iframe>
...
<div id="footer" class="footer">
	Powered by <a href="http://w.jieqiangtec.com" target="_blank">JieQiangCms</a>&nbsp;<?php echo VERSION;?>  Released&nbsp;20140712 Copyright 2013-2018
</div>
...
function edit(id, name) {
	...
	window.top.art.dialog({title:lang_edit+'--'+name,id:'edit',iframe:'?m=Admin&a=pwd&id='+id,width:'480',height:'250'}, function(){var d = window.top.art.dialog({id:'edit'}).data.iframe;d.document.getElementById('dosubmit').click();return false;}, function(){window.top.art.dialog({id:'edit'}).close()});
}
