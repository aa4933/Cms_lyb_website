...
<div class="pad_10">
    <form action="<?php echo u('User/edit');?>" method="post" name="myform" id="myform" enctype="multipart/form-data" >
        ...
        <table width="100%" cellpadding="2" cellspacing="1" class="table_form">
			...
			<tr>
                <th width="60">会员密码:</th>
                <td><input class="input-text" type="password" name="password" id="password" size="25" value="" >
					<span style="color:red;">*密码为空表示不修改密码，不为空则表示要修改密码，</span>
				</td>
				
            </tr>
			<tr>
				<th width="60"><?php echo L('integral');?> :</th>
				<td><input type="text" name="integral" id="integral" size="14" value="<?php echo ($info["integral"]); ?>" ></td>
			</tr>			
			<tr>
                <th width="60"><?php echo L('email');?> :</th>
                <td><input type="text" name="email" id="email" size="25" value="<?php echo ($info["email"]); ?>" ></td>
            </tr>
			<tr>
                <th><?php echo L('sex');?> :</th>
                <td><input type="radio" name="sex" value="0" <?php if($info["sex"] == '0'): ?>checked<?php endif; ?>>&nbsp;男&nbsp;&nbsp;&nbsp; 
